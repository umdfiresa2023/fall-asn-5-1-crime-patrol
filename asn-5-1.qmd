...
Answer: crime rate per neighborhood.
...
treatment: indicator of whether there is wind in each county
...
Answer: Days where the winds is blowing
...
ggplot(final, aes(x = treatment, y = ))
```
